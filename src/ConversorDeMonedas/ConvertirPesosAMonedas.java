...
public class ConvertirPesosAMonedas {
	...
	public void ConvertirPesosALibras(double valor) {
        ...
        JOptionPane.showMessageDialog(null, "son: $ " +monedaLibra+ " Libras Esterlinas");
	}
	
	public void ConvertirPesosAYen(double valor) {
		double monedaYen = valor / 28.44;
        monedaYen = (double) Math.round(monedaYen *100d)/100;
        JOptionPane.showMessageDialog(null, "son: $ " +monedaYen+ " Yuanes");
	}
	
	public void ConvertirPesosAWon(double valor) {
		double monedaWon = valor / 3.09;
        monedaWon = (double) Math.round(monedaWon *100d)/100;
        JOptionPane.showMessageDialog(null, "son: $ " +monedaWon+ " Wons");
	}
